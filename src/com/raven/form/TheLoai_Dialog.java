...
public class TheLoai_Dialog extends javax.swing.JDialog {
     ...
     */
    public TheLoai_Dialog(java.awt.Frame parent, boolean modal, ActionType2 actionType) {
        super(parent, modal);
        initComponents();
        this.actionType = actionType;
        this.setLocationRelativeTo(null);
        if (actionType == ActionType2.EDIT) {
    ...
    private void luuBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_luuBtnActionPerformed
        ...
        } else if (actionType == ActionType2.EDIT) {
            if(!checkNull()){
                return;
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TheLoai_Dialog dialog = new TheLoai_Dialog(new javax.swing.JFrame(), true, ActionType2.ADD);
